...
// EKLENEN KISIM: Community Dashboard Importu
import { CommunityComponent } from './pages/community-dashboard/community.component'; 
...
export const routes: Routes = [
    ...
    { path: 'sss', component: FaqPageComponent }, // Sıkça Sorulan Sorular (SSS)
    { path: 'faq', component: FaqPageComponent }, // İstersen hem sss hem faq olarak erişilebilir
    
    // EKLENEN KISIM: Community Dashboard Rotası
    { path: 'community-dashboard', component: CommunityComponent },
    // ------------------------------
