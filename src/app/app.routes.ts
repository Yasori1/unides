...
=======
  ...
  { path: 'communities', component: CommunitiesPageComponent },
  { path: 'communities/:id', component: CommunityDetailComponent, data: { animation: 'communityDetail' } },
  { path: 'events', component: EventsComponent },
  { path: 'events/:id', component: EventsDetailComponent, data: { animation: 'eventDetail' } },
  { path: 'announcements', component: AnnouncementsPageComponent },
  { path: 'announcements/:id', component: AnnouncementDetailComponent, data: { animation: 'announcementDetail' } },
>>>>>>> Stashed changes
