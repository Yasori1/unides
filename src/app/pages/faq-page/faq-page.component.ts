...
export class FaqPageComponent implements OnInit, AfterViewInit {
  ...
  allCategories: FaqCategory[] = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: 'Hayır. Platformun güvenliğini sağlamak amacıyla; sisteme yalnızca geçerli bir üniversite e-posta adresi (.edu / .edu.tr) ile kayıt olunabilmektedir.',
          isOpen: false
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: 'Gerçekleştirdiğiniz projelere ait görselleri ve sonuç metinlerini <strong>unidesbilgi@gsb.gov.tr</strong> adresine iletmeniz gerekmektedir.',
          isOpen: false
        }
      ]
    },
      ...
      items: [
        {
          ...
          answer: 'Tüm başlıklar ve mesajlar yönetici onayı sürecinden geçmektedir. Onaylandıktan sonra yayınlanacaktır.',
          isOpen: false
        },
        {
  ...
  filterFaq() {
    if (!this.searchText || this.searchText.trim() === '') {
      ...
      this.filteredCategories = this.allCategories.map(cat => {
