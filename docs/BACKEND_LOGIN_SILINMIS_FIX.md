...
Bu değişiklik backend projesinde (UNIDES.API.New) uygulanmalıdır. **Backend ekibine aşağıdaki “Backend ekibine iletilmesi gereken değişiklikler” dokümanını iletin.**
